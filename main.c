...
//////////////////////////////////////////////////////////////
    ...
    for (i = 0; i < all_buckets; i++) {
        ...
        //printf(" O  R exei %d kai o S %d \n", Hist_array_R[i].count, Hist_array_S[i].count);
      ...
      //  printf("bucket[] \n ");
        ...
        //printf("chain[] \n");
        for (count = 0; count < table_index->num_tuples + 1; count++) {
          //  printf("%d \n ", chain[count]);
        }
    ...
    printf("telos preimenw apo lista\n");
    printResults(rhj);
    printf("tipota\n");
}
